...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        <a class="navbar-brand" href="#">PEDIATRIA
        ...
        <div class="collapse navbar-collapse" id="usuario">
            <div class="navbar-nav text-center ml-auto mr-auto">
                ...
                <a href="pacientes.php" class="nav-item nav-link">Pacientes<span class="sr-only">(current)</span></a>
                <a href="estadisticas.php" class="nav-item nav-link" active>Estadísticas</a>
            </div>
            <div>
