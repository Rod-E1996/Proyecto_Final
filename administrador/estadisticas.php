    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../administrador/grafico.php" class="nav-link active">
              <i class="nav-icon fas fa-user-injured"></i>
              <p>
                Estad&iacute;sticas
              </p>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Estad&iacute;sticas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card card-warning">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <div class="card-body vista">
                        <!-- DONUT CHART -->
                        <div class="card card-danger">
                            <div class="card-header">
                            <h3 class="card-title">Pacientes por sexo</h3>
...
<?php
    $query="SELECT COUNT(*) AS `hombres` FROM `pacientes` WHERE `paciente_sexo` = 'Masculino'";
    $result = mysqli_query($conexion, $query);
    $row = mysqli_fetch_array($result);
    //Consulta sobre mujeres//
    //////////////////////////
    $query2="SELECT COUNT(*) AS `mujeres` FROM `pacientes` WHERE `paciente_sexo` = 'Femenino'";
    $result2 = mysqli_query($conexion, $query2);
    $row2 = mysqli_fetch_array($result2);
    echo "<p align='right'>Hombres: '".$row['hombres']."', Mujeres: '".$row2['mujeres']."'</p>";
?>
<script>
$(function () {
