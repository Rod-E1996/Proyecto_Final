    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../usuario/pacientes.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../dashboard/../dashboard/pages/calendar.html" class="nav-link">
      ...
      <div class="row" id="contenido_principal">
        <div class="col-md-12">
          <div class="card card-warning">
            ...
            <!-- /.card-header -->
            <div class="card-body vista" id="pacientes">
              Contenido
            </div>
            <!-- /.card-body -->
          </div>
  ...
  if ($resultado->num_rows>0){
    while ($row=$resultado->fetch_assoc()) {
      if ($row['imagen']==null || $row['imagen']=="") {
        ...
        <script>
          Swal.fire({
              title: '<strong>Hola <?php echo $varsesion;?>!<br> Bienvenido de nuevo</strong>',
              icon: 'warning',
              html:
                  'Hemos visto que aun no tienes foto de perfil en tu usuario.<br>' +
                  'Te recomendamos hacerlo cuanto antes para disfrutar de una mejor experiencia!',
