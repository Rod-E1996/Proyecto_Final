...
<div class="container-fluid">
    ...
    <table class="table table-striped table-hover table-bordered" id="tabla">
        ...
        <tbody>
            <?php
                $consulta="SELECT * FROM pacientes where 'id_paciente'={$_SESSION['id_paciente']}";
                ...
                while ($row=$result->fetch_assoc()) {?>
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            <a href="paciente.php?id=<?php echo convert_uuencode($row['id_paciente']); ?>" class="btn btn-outline-primary">Ver paciente</a>
                        </td>
                    </tr>
                <?php
                }
